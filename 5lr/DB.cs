...
namespace _5lr
{
    ...
    {   public static MySqlConnection GetConnection()
        {
            string sql = @"server=localhost;port=3306; database=mydb;uid=root;pwd=123456;";
 ...
 //       public void closeConnect()
  ...
  //         conn.Close();
   ...
   //     }
        ...
        public static void delete_object(string id)
        {
            string sql = "DELETE FROM Obect WHERE idObect=@id";
            MySqlConnection mycon = GetConnection();
            MySqlCommand cmd = new MySqlCommand(sql, mycon);
            cmd.CommandType = System.Data.CommandType.Text;
        ...
        public static void change_object(Object std, string id)
        {
        ...
        public static void delete_event(string id)
        {
        ...
        public static void change_event(Event std, string id)
        {
        ...
        public static void delete_onwer(string id)
        {
        ...
        public static void change_onwer(Onwer std, string id)
        {
        ...
        public static void delete_obj_pop(string id)
        {
        ...
        public static void change_obj_pop(Obj_Pop std, string id)
        {
        ...
        public static void delete_status_onwer(string id)
        {
            string sql = "DELETE FROM Status_Onwer WHERE idStatus_Onwer=@id";
            MySqlConnection mycon = GetConnection();
            MySqlCommand cmd = new MySqlCommand(sql, mycon);
            cmd.CommandType = System.Data.CommandType.Text;
            cmd.Parameters.Add("@id", MySqlDbType.Int32).Value = id;
        ...
        public static void change_status_onwer(Status_Onwer std, string id)
        {
